...
function draw() {
  ...
  strokeWeight(3);
  fill(255,255,255,80)
  ellipse(windowWidth*(36/100)+25,windowHeight*(33/100)+65,40);
  ellipse(windowWidth*(45/100)+25,windowHeight*(33/100)+65,20);
  ellipse(windowWidth*(81/100)+25,windowHeight*(33/100)+65,20);
  ellipse(windowWidth*(27/100)+25,windowHeight*(41/100)+65,20);
  ellipse(windowWidth*(36/100)+25,windowHeight*(25/100)+65,20);
  ellipse(windowWidth*(36/100)+25,windowHeight*(17/100)+65,20);
  ellipse(windowWidth*(36/100)+25,windowHeight*(9/100)+65,20);
  ellipse(windowWidth*(36/100)+25,90,20);
  ellipse(windowWidth*(9/100)+25,90,20);
  ellipse(windowWidth*(45/100)+25,windowHeight*(25/100)+65,20);
  ellipse(windowWidth*(54/100)+25,windowHeight*(25/100)+65,40);
  ...
  ellipse(windowWidth*(81/100)+25,windowHeight*(17/100)+65,20);
  ellipse(windowWidth-40,windowHeight*(17/100)+65,20);
  ellipse(windowWidth-40,90,20);
  ellipse(windowWidth*(72/100)+25,windowHeight*(9/100)+65,20);
