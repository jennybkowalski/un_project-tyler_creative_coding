...
function draw() {
  ...
  ellipse(windowWidth*(63/100)+25,windowHeight*(25/100)+65,40);
  ellipse(windowWidth*(45/100)+25,90,20);
  ellipse(windowWidth*(63/100)+25,windowHeight*(9/100)+65,20);
  ellipse(windowWidth*(18/100)+25,windowHeight*(41/100)+65,20);
  ellipse(windowWidth*(72/100)+25,windowHeight*(9/100)+65,20);
  ellipse(windowWidth*(45/100)+25,windowHeight*(25/100)+65,20);
  ellipse(windowWidth*(9/100)+25,windowHeight*(41/100)+65,20);
