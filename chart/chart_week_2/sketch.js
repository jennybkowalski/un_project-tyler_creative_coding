...
function draw() {
  ...
  strokeWeight(3);
  fill(255,255,255,80)
  ellipse(windowWidth*(27/100)+25,windowHeight*(49/100)+65,20);
  ellipse(windowWidth*(27/100)+25,windowHeight*(17/100)+65,40);
  ellipse(windowWidth*(36/100)+25,windowHeight*(17/100)+65,20);
  ellipse(windowWidth*(45/100)+25,windowHeight*(17/100)+65,20);
